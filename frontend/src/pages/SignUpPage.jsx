                ...
                <div className='relative border m-5 md:m-14 p-5 md:p-10 w-full md:w-[450px] h-auto  md:-top-8 rounded-lg'>
                    ...
                    <form action="" className='flex flex-col gap-4 pt-6'>
                        <div className=' border-b'>
                            <input type="text" placeholder='First Name' className='w-[370px] h-10 p-2' />
                        </div>
                        <div className='border-b'>
                            <input type="text" placeholder='Last Name' className='w-[370px] h-10 p-2' />
                        </div>
                        <div className='border-b flex justify-between'>
                            <input type={showPassword ? "text" : "password"} placeholder='Set Password' className='w-[370px] h-10 p-2' />
                            <div onClick={togglePasswordVisibility} className='self-center'>
                                {showPassword ? <Eye color='#3A244A' /> : <EyeOff color='#3A244A' />}
                            </div>
                        </div>
                        <div className='border-b flex justify-between'>
                            <input type={showConfirmPassword ? "text" : "password"} placeholder='Retype Password' className='w-[370px] h-10 p-2' />
                        ...
                        <div className='border-b flex justify-between h-10'>
                            ...
                            <select name="" placeholder="Contact mode" id="">
                                <option value="email">Email</option>
                                <option value="phone">Phone</option>
                            </select>
                        </div>
                        <div className='border-b'>
                            <input type="email" placeholder='Enter Email' className='w-[370px] h-10 p-2' />
                        </div>
